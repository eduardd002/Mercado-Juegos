    ...
    class Uso{
        ...
        */
        ...
        public function guardar(){
            ...
            $consulta = "INSERT INTO usos VALUES(NULL, '{$this -> getNombre()}')";
        ...
        */
        ...
        public function listar(){
            //Construir la consulta
            $consulta = "SELECT DISTINCT * FROM usos";
            //Ejecutar la consulta
        ...
        */
        ...
        public function obtenerUno(){
            //Construir la consulta
            $consulta = "SELECT DISTINCT * FROM usos WHERE id = {$this -> getId()}";
            //Ejecutar la consulta
        ...
        */
        ...
        public function eliminar(){
            //Construir la consulta
            $consulta = "UPDATE usos WHERE id = {$this -> getId()}";
            //Ejecutar la consulta
