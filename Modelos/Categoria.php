    ...
    class Categoria{
        ...
        */
        ...
        public function listar(){
            /*Construir la consulta*/
            $consulta = "SELECT DISTINCT * FROM categorias WHERE activo = 1 ORDER BY nombre ASC";
            /*Llamar la funcion que ejecuta la consulta*/
        ...
        */
        ...
        public function listarInactivas(){
            /*Construir la consulta*/
            $consulta = "SELECT DISTINCT * FROM categorias WHERE activo = 0";
            /*Llamar la funcion que ejecuta la consulta*/
            $lista = $this -> db -> query($consulta);
            /*Retornar el resultado*/
            return $lista;
        ...
        */
        ...
        public function recuperarCategoria(){
            ...
            if($this -> getId() != null){
                /*Construir la consulta*/
                $consulta = "UPDATE categorias SET activo = 1 WHERE id = {$this -> getId()}";
